...
val SurfaceColor = Color(0xFF24252A) // корточки, нижнее меню
val SurfaceVariantColor = Color(0xFF32333A) // фон полей ввода
...
val VkButtonColor = Color(0xFF2683ED)
val OkButtonGradientStartColor = Color(0xFFF98509)
val OkButtonGradientEndColor = Color(0xFFF95D00)
